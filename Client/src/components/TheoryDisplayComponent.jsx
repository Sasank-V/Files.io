                    ...
                    <DialogContent className="sm:max-w-[425px] border-0 bg-white dark:bg-gray-800 text-white dark:text-gray-100 font-vssemibold" style={{ background: 'linear-gradient(135deg, #1A1A1A 0%, #2A2A2A 50%, #1A1A1A 100%)' }}>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-4">
                            <div className="space-y-2">
                                <Label htmlFor="title" className="text-sm font-medium">{isTheory ? "Module" : "Experiment"} Title</Label>
                                <Input
                                    id="title"
                                    name="title"
                            ...
                            <div className="space-y-2">
                                <Label htmlFor="unitNo" className="text-sm font-medium">{isTheory ? "Module" : "Experiment"} Number</Label>
                                <Input
                                    id="unitNo"
                                    name="unitNo"
                                    type="number"
                            ...
                            <div className="space-y-2">
                                <Label htmlFor="description" className="text-sm font-medium  dark:text-gray-300">{isTheory ? "Module" : "Experiment"} Description</Label>
                                <Textarea
                                    id="description"
                                    name="description"
